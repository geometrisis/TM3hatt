...
36 INPUT "reply: ", eO, n0, xe, yn
37 PRINT "input: D3,D4,D5,D6,D7,DB"
38 INPUT "reply: ", x1, y1, x2, y2, x3, y3
39 x2 = x2 * .00000001#
40 y2 = y2 * 1E-10
41 x3 = x3 * 1E-14
42 y3 = y3 * 1E-16
43 PRINT "input: point number,X,Y, (X=Y=0 to stop)"
44 INPUT "reply: ", nm, x, y
...
83 IF dx < 0 AND dy < 0 THEN az = PI + az
